...
class EncoderDecoder(nn.Module):
    ...
    def forward(self, X_batch): 
        ...
        # 2) LSTM 
        Y0 = torch.tensor(self.vocab_size, self.batch_size)
        Y0[141,:] = 1
        input(Y0[141,:])
...
def main():
    ...
    ED = EncoderDecoder(input_size=input_size, hidden_size=hidden_size, batch_size=batch_size, sequence_length=sequence_length, vocab_size=vocab_size)

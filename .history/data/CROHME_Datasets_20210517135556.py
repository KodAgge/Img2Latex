...
TEST_IMGS = loadImages(path_test, width, height, n_test, scale)
TRAIN_IMGS = loadImages(path_train, width, height, n_train, scale)
VAL_IMGS = loadImages(path_val, width, height, n_val, scale)
